...
const Particle = ({ size, left, top, delay, color }: { size: number; left: number; top: number; delay: number; color: string }) => {
...
export default function CelestialTitle({ title, atHome = false }: { title: string, atHome?: boolean }) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {!atHome && <Text
          style={[styles.secondaryTitleText, { color: colors.textColor }]}
        >
          Celestial
        </Text>}
        <Text
        ...
        <View style={[styles.underline, { backgroundColor: colors.underlineColor }]} />
      </Animated.View>
      <View style={{
        position: "absolute",
        top: 50,
      ...
      >
        <Svg height="200%" width="100%">
          <Defs>
            ...
            >
              <Stop offset="0" stopColor={colors.gradientPrimary} stopOpacity="1" />
              <Stop offset={theme === 'light'?"0.0001":"0.3"} stopColor={colors.gradientPrimary} stopOpacity="0.6" />
              <Stop offset="1" stopColor={colors.gradientPrimary} stopOpacity="0" />
            </RadialGradient>
          </Defs>
